...
`data/result` directory.You can proceed with further analysis according to your specific needs.![ACMGA](https://github.com/HFzzzzzzz/ACMGA/raw/master/workflow/image/schematic.jpg)
...
## MAF file to VCF file
 MAF files can be converted into GVCF files through [TASSEL](https://www.maizegenetics.net/tassel), and then the VCF file can be obtained through GATK.
 ```
...
```
## Calling  SNP and INDEL from VCF file
```
