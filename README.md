...
Using this approach, slight modifications to some of the paths within `command.sh` are necessarym, give the software executable permissions, and add the path of the executable program to the environment variable.
